...
// std::cout<<"left: "<<*h_left<<std::endl;
		// std::cout<<"right: "<<*h_right<<std::endl;
		// std::cout<<"bottom: "<<*h_bottom<<std::endl;
		// std::cout<<"top: "<<*h_top<<std::endl;
		// for(int j=0;j<4*numNodes;j++){
		// 	std::cout<<h_child[j]<<" ";
		// }
		// std::cout<<""<<std::endl;
		// std::cout<<""<<std::endl;
